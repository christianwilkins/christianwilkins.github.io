...
export const learningModules: LearningModule[] = [
  {
    ...
    description:
      "A language agnostic curriculum on system design, prompting, architecture, and delivery.",
    topics: ["System design", "Prompting", "Automation", "Product"],
    status: "live",
    ...
    level: "starter",
    duration: "12 weeks",
    outcome: "Ship production ready systems with repeatable AI assisted workflows.",
  },
  {
    id: "agentic-ops-patterns",
    title: "Automation Ops Patterns",
    description:
      "Hands on patterns for long running automation with retries, approvals, and budget limits.",
    ...
    level: "intermediate",
    duration: "4 weeks",
    outcome: "Design async workflows that run safely with minimal supervision.",
  },
  {
