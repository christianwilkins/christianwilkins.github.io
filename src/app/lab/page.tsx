...
import { ArrowRight, Beaker, BookOpenText, Bot, Braces, Compass, Layers3, MessageSquareText, ShieldCheck } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { siteConfig } from "@/data/siteConfig";

const labDescription = "The Lab by Christian Wilkins with practical experiments in system design, tooling, and product workflows.";
...
const nodes: LabNode[] = [
  {
    title: "Learning Hub",
    href: "/lab/learning",
    description: "Curriculum modules for system design, prompting, and execution.",
    state: "live",
    icon: Compass,
    note: "Start here",
  },
  ...
  },
  {
    title: "Pretext Demo",
    href: "/lab/pretext",
    description: "Interactive glossary demo powered by chenglou/pretext.",
    state: "live",
    icon: Braces,
    note: "Text UX",
  },
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl space-y-10">
        <header className="rounded-3xl border border-border/70 bg-card/55 p-6 md:p-8">
          ...
          <p className="mt-4 max-w-4xl text-lg text-muted-foreground leading-relaxed">
            This is where I run product experiments that are meant for real use.
            Each module is designed to help teams ship faster without dropping quality.
          </p>
        </header>
        ...
        <section className="rounded-3xl border border-dashed border-border/70 bg-muted/20 p-6">
          <div className="flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>Principle: clear language, strong architecture, and practical automation.</span>
          </div>
        </section>
      </div>
    </div>
